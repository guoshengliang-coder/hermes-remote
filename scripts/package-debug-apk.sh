...
# The in-app feedback entry is invisible unless the APK carries both MissionGo values. Read the
# generated BuildConfig that fed this compilation, then prove both constants are present in the
