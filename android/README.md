...
- Version 0.1.97 identifies this app to Hermes as its own client (`source=hermes_remote`) on
  ...
  `platform_hints` config (docs/HERMES_CONTRACT.md). Artifact download failures now report
  distinct codes (HR-FILE-003..007) instead of one message, and the Connector logs refusals.
