...
| D0.2 presentation orchestration | Separate account presentation, legacy observation, and diagnostics orchestration from the root view model | Existing state reduction and restart behavior remain green |
